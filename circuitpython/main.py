...
pixel_pin = board.D4  # The pin the NeoPixels are connected to
button_switch_pin = board.D3  # Pin button is attached to
vibration_switch_pin = board.D2  # Pin vibration switch is attached to.
pixel_count = 144  # Number of pixels in your strip
...
flash_color = cycle_sequence(
    [RED, YELLOW, ORANGE, GREEN, TEAL, CYAN, BLUE, PURPLE, MAGENTA, WHITE]
)
