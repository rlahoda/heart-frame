...
chase_color_duration = 0.1  # Seconds each color lasts in the color chase mode

pixels = neopixel.NeoPixel(pixel_pin, pixel_count, brightness=0.4, auto_write=False)
